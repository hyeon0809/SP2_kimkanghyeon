...
#define _DUTY_MAX 2375 // 2000
#define _DUTY_NEU 2022 // 1500
#define _DUTY_MIN 1544 // 1000
...
float volt_to_distance(int a_value)
{
  ...
  return 667 - 2.65*a_value + 3.5E-03*a_value*a_value - 1.55E-06*a_value*a_value*a_value;
}
